...
namespace Parse {
    ...
    // I don't know what to call this, but Parse has two Pointer-s.
    // This one is returned by Object.get()
    interface Pointer2 {
        _objCount: string;
        className: string;
        id: string;
    ...
    namespace Cloud {
        ...
        interface ValidationFieldOptions {
            ...
            default?: any;
            required?: boolean;
            options?: any | any[] | ((value: any) => boolean);
            constant?: boolean;
            error?: string;
        }
        ...
        interface ValidationOptions {
            ...
            fields?: string[] | {[fieldName: string]: ValidationFieldOptions};
            requireUserKeys?: string[];
        }
        ...
        function define(name: string, func: (request: FunctionRequest) => any, validationOptions?: ValidationOptions | ((request: FunctionRequest) => void)): void;
